...
if (isset($_POST['form1'])) {
    ...
    if(empty($_POST['cust_name']) || !preg_match('/[a-zA-Z]{6,}/', $_POST['cust_name'])) {
        $valid = 0;
        $error_message .= "Name must contain at least 6 alphabetic characters.<br>";
    }
    if(empty($_POST['cust_cname']) || !preg_match('/[a-zA-Z]{6,}/', $_POST['cust_cname'])) {
        $valid = 0;
        $error_message .= "Company name must contain at least 6 alphabetic characters.<br>";
    }
    ...
    if(empty($_POST['cust_address']) || !preg_match('/[a-zA-Z]{6,}/', $_POST['cust_address'])) {
        $valid = 0;
        $error_message .= "Address must contain at least 6 alphabetic characters.<br>";
    }
    ...
    if(empty($_POST['cust_city']) || !preg_match('/[a-zA-Z]{6,}/', $_POST['cust_city'])) {
        $valid = 0;
        $error_message .= "City must contain at least 6 alphabetic characters.<br>";
    }

    if(empty($_POST['cust_state']) ) {
        $valid = 0;
        $error_message .= "State must contain at least 6 alphabetic characters.<br>";
    }

    if(empty($_POST['cust_zip']) || !preg_match('/^\d{4,}$/', $_POST['cust_zip'])) {
        $valid = 0;
        $error_message .= "ZIP code must contain at least 4 numbers only.<br>";
    }
    ...
    } elseif (!preg_match('/[A-Za-z]/', $_POST['cust_password']) || !preg_match('/[0-9]/', $_POST['cust_password']) || !preg_match('/[^A-Za-z0-9]/', $_POST['cust_password'])) {
        $valid = 0;
        $error_message .= "Password must contain at least one letter, one number, and one special character.<br>";
